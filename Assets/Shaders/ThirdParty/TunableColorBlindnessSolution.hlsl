...
float colorBlindProtanopiaFactor	< Attribute( "ProtanopiaFactor" ); Default( 0.0 ); >;
float colorBlindDeuteranopiaFactor	< Attribute( "DeuteranopiaFactor" ); Default( 0.0 ); >;
float colorBlindTritanopiaFactor	< Attribute( "TritanopiaFactor" ); Default( 0.0 ); >;

float colorBlindDaltonizeFactor		< Attribute( "DaltonizeFactor" ); Default( 0.0 ); >;
float accessibilityBrightnessFactor	< Attribute( "BrightnessFactor" ); Default( 0.0 ); >;
float accessibilityContrastFactor	< Attribute( "ContrastFactor" ); Default( 0.0 ); >;
